...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        ## USER ICON ==> SHOW HIDE
        UIFunctions.userIcon(self, "G5", "", True)
        ## ==> END ##
    ...
    def buy_select_addBtn_clicked(self):
        ...
        if int(self.ui.buy_select_volEdit.text()) if self.ui.buy_select_volEdit.text()!='' else 0 <= int(self.ui.buy_select_Table.selectedIndexes()[3].data()) if self.ui.buy_select_Table.selectedIndexes()[3].data()!='' else 0:
            data.append(int(self.ui.buy_select_volEdit.text()) if self.ui.buy_select_volEdit.text()!='' else 0)
        ...
        print(len(self.buy_model.user_data))
        ...
        databaseOperations.update_existing_stock_add(data[3],data[5],data[0],data[1])
